...
public class HocPhiGUI extends JPanel {
	private JTextField txtTimMaSV;
	...
	public HocPhiGUI() {
		...
		panel.setBounds(346, 10, 584, 308);
		add(panel);
		...
		scrollPane.setBounds(94, 367, 1082, 386);
		add(scrollPane);
		
		JLabel lblNewLabel = new JLabel("Mã SV:");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblNewLabel.setBounds(105, 325, 73, 33);
		add(lblNewLabel);
		
		txtTimMaSV = new JTextField();
		txtTimMaSV.setBounds(188, 334, 356, 25);
		add(txtTimMaSV);
		txtTimMaSV.setColumns(10);
		
		JComboBox comboBox = new JComboBox();
		comboBox.setBounds(554, 336, 267, 21);
		add(comboBox);
		
		JButton btnTK = new JButton("Tìm");
		btnTK.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnTK.setBounds(824, 328, 60, 33);
		add(btnTK);
	}
}
